...
bool AssemblyPatches::Apply() {
...

	{
		...
		*/
		...
		uint8 arrOldBytes[PatchSize] = {
			...
			0x4C, 0x8D, 0x05, 0x92, 0x74, 0xD1, 0x00,	// lea r8, ["VoxelTerrain"]
...

	{
		...
		uint8 arrOldBytes[PatchSize] = {
			...
			0xC7, 0x00, 0x01, 0x00, 0x00, 0x00,			// mov [rax], 0x1
			0x4C, 0x8D, 0x05, 0x4E, 0x7C, 0xD1, 0x00,	// lea r8, ["VoxelTerrain"]
			0xBA, 0xF0, 0xD8, 0xFF, 0xFF,				// mov edx, LUA_REGISTRYINDEX
			0x48, 0x8B, 0x0B,							// mov rcx, [rbx]
...

	{
		...
		uint8 arrOldBytes[PatchSize] = {
			...
			0x48, 0x8D, 0x15, 0x86, 0x5E, 0x8A, 0x00,	// lea rdx, ["warehouse"]
			0xE8, 0x41, 0xE0, 0x63, 0x00,				// call memcmp
